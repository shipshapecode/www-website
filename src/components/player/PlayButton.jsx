...
export function PlayButton({ player, size = 'large' }) {
  return (
    <button
      type="button"
      className={clsx(
        'group relative flex flex-shrink-0 items-center justify-center rounded-full bg-slate-700 transition-colors hover:bg-slate-900 focus:outline-none focus:ring-slate-700',
        {
